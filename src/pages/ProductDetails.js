...
const ProductDetails = () => {
  ...
  if (!selectedVariation || selectedQuantity > selectedVariation.quantity) {
    toast.error("No hay suficientes productos disponibles");
    return;
  }
        ...
        <div className="size-quantity">
          <div className="row container d-flex justify-content-left pb-3">
            <div className="col-2 col-sm-2">
             ...
             <select class="form-select  "  value={selectedSize} onChange={handleSizeChange}>
          ...
          {selectedSize && (
            ...
            {product?.variations?.map((variation) => {
               ...
               // Agrega la declaración de selectedVariation aquí
